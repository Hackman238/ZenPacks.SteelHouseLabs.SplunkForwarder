...
import logging
import os
log = logging.getLogger('zen.splunkforwarder')

import ZenPacks.SteelHouseLabs.SplunkForwarder
...
class ZenPack(ZenPackBase):
    ...
    def install(self, app):
        ...
        # Start daemon
        self.startDaemon(app.zport.dmd, daemonName='splunkforwarder')
    ...
    def remove(self, app, leaveObjects=True):
        ...
        # Stop daemon
        self.stopDaemon(app.zport.dmd, daemonName='splunkforwarder')
    ...
    def symlinkPlugin(self):
        ...
        os.system('ln -sf %s %s' % (self.path('daemon/splunkforwarder'), zenPath('bin', 'splunkforwarder')))
        os.system('chmod a+x %s' % (zenPath('bin', 'splunkforwarder')))
        os.system('touch %s' % (zenPath('etc', 'splunkforwarder.conf')))


    def removePluginSymlink(self):
        log.info('Removing daemon from $ZENHOME/bin')
        os.system('rm -f %s' % (zenPath('bin', 'splunkforwarder')))
